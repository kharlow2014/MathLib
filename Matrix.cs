//Keaton Harlow
//Program to do various manipulation of a matrix
...
namespace MatrixApp {
    public class Matrix {
        ...
        // If the dimensions are not equal, returns 0
        ...
        // matrices.
        // If the matrices can't be multiplied, returns 0.
        public static Matrix operator* (Matrix A, Matrix B) {
    ...
    class MatrixTest {
        public static void Main(string[] args) {
            ...
            double[, ] set = new double[, ] {{-2, -9, 2, -4, 1}, {-10, 2, -5, -10, -9}, {-3, 1, -10, 0, 1}, {-8, -10, 3, -1, -10}, {1, -3, -8, -2, -1}};
            mat.setMat(set);
            mat.LUDecomp();
            Console.WriteLine(mat.LUDeterminant());
        }
    }
}